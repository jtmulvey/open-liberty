...
public class HttpConnector {
    ...
    static {
        ...
        System.out.println("**** JTM ****  calling getResourceAsStream !");

        try (InputStream in = HttpConnector.class.getResourceAsStream("/com/ibm/ws/acme/internal/org/shredzone/acme4j/version.properties")) {
