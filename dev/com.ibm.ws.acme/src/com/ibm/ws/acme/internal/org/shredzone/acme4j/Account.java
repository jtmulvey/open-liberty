...
import static com.ibm.ws.acme.internal.org.shredzone.acme4j.toolbox.AcmeUtils.*;
...
import com.ibm.ws.acme.internal.org.shredzone.acme4j.connector.ResourceIterator;
...
public class Account extends AcmeJsonResource {
    ...
    public Authorization preAuthorizeDomain(String domain) throws AcmeException {
        ...
        System.out.println("preAuthorizeDomain {} " + domain);
        try (Connection conn = connect()) {
